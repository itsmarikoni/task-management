...
public class CardController {
	...
	public CardResponse updateCardPosition(@PathVariable Long id, @Valid @RequestBody CardPositionUpdateRequest request) {
		return cardService.updateCardPosition(id, request);
	}
